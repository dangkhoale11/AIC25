...
from app.core.settings import KeyFrameIndexMilvusSettingBatch2, KeyFrameIndexMilvusSetting
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Migrate embedding to Milvus for batch 2.")
    parser.add_argument(
        "--file_path", type=str, help="Path to embedding pt."
    )
    args = parser.parse_args()

    setting =  KeyFrameIndexMilvusSettingBatch2()
